...
from sma.ui._safety import is_minimal_mode, log_minimal_mode, swallow_ui_error, ui_safe


def test_swallow_ui_error_logs_and_calls_fallback(caplog: pytest.LogCaptureFixture) -> None:
    caplog.set_level(logging.ERROR, logger="sma.ui._safety")
...
def test_minimal_mode_flag(monkeypatch: pytest.MonkeyPatch, caplog: pytest.LogCaptureFixture) -> None:
    caplog.set_level(logging.INFO, logger="sma.ui._safety")
