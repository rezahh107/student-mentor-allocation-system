...
class HardenedAPIConfig:
    ...
    idempotency_compress_min_bytes: int = 16_384
    idempotency_max_cache_bytes: int = 1_000_000
    ...
    def from_env(cls) -> "HardenedAPIConfig":
        ...
        compress_threshold = int(os.getenv("ALLOC_API_IDEMPOTENCY_COMPRESS_MIN", "16384"))
        max_cache_bytes = int(os.getenv("ALLOC_API_IDEMPOTENCY_MAX_CACHE", "1000000"))
        ...
        return cls(
            ...
            idempotency_compress_min_bytes=compress_threshold,
            idempotency_max_cache_bytes=max_cache_bytes,
            pii_salt=pii_salt,
...
def create_app(
    ...
    *,
    ...
    if settings.redis_url:
        ...
        idempotency_store: IdempotencyStore = RedisIdempotencyStore(settings.redis_url, namespace=instance_namespace, observability=obs)
    else:
    ...
    middleware_stack = [
        ...
        Middleware(
            ...
            observability=obs,
            paths=("/allocations",),
            compress_min_bytes=settings.idempotency_compress_min_bytes,
            max_cache_bytes=settings.idempotency_max_cache_bytes,
        ),
