...
@pytest.fixture
def api_client(httpx_client_factory) -> tuple[Any, DummyAllocator, CollectorRegistry, dict[str, str]]:
    ...
    return client, allocator, registry, secrets_map
...
def test_post_allocation_success(api_client: tuple[Any, DummyAllocator, CollectorRegistry, dict[str, str]]) -> None:
...
def test_handles_persian_digits(api_client: tuple[Any, DummyAllocator, CollectorRegistry, dict[str, str]]) -> None:
...
def test_zero_width_student_id_rejected(api_client: tuple[Any, DummyAllocator, CollectorRegistry, dict[str, str]]) -> None:
...
def test_missing_auth_returns_401(api_client: tuple[Any, DummyAllocator, CollectorRegistry, dict[str, str]]) -> None:
...
def test_invalid_token_returns_401(api_client: tuple[Any, DummyAllocator, CollectorRegistry, dict[str, str]]) -> None:
    client, _, _, _ = api_client
...
def test_scope_enforcement(api_client: tuple[Any, DummyAllocator, CollectorRegistry, dict[str, str]]) -> None:
    client, _, _, secrets_map = api_client
...
def test_api_key_authentication(api_client: tuple[Any, DummyAllocator, CollectorRegistry, dict[str, str]]) -> None:
    client, allocator, _, secrets_map = api_client
    headers = {
        "Content-Type": "application/json; charset=utf-8",
...
def test_rate_limiting_enforced(api_client: tuple[Any, DummyAllocator, CollectorRegistry, dict[str, str]]) -> None:
    client, _, _, secrets_map = api_client
...
def test_idempotency_replay(api_client: tuple[Any, DummyAllocator, CollectorRegistry, dict[str, str]]) -> None:
    client, allocator, _, secrets_map = api_client
...
def test_idempotency_conflict(api_client: tuple[Any, DummyAllocator, CollectorRegistry, dict[str, str]]) -> None:
    client, _, _, secrets_map = api_client
...
def test_body_size_guard(api_client: tuple[Any, DummyAllocator, CollectorRegistry, dict[str, str]]) -> None:
    client, _, _, secrets_map = api_client
...
def test_content_type_guard(api_client: tuple[Any, DummyAllocator, CollectorRegistry, dict[str, str]]) -> None:
    client, _, _, secrets_map = api_client
...
def test_metrics_requires_auth_or_allowlist(api_client: tuple[Any, DummyAllocator, CollectorRegistry, dict[str, str]]) -> None:
    client, _, _, secrets_map = api_client
...
def test_observability_logs_mask_pii(api_client: tuple[Any, DummyAllocator, CollectorRegistry, dict[str, str]]) -> None:
    client, _, _, secrets_map = api_client
...
def test_idempotent_replay_header(api_client: tuple[Any, DummyAllocator, CollectorRegistry, dict[str, str]]) -> None:
    client, allocator, _, secrets_map = api_client
...
def test_validation_errors_include_details(api_client: tuple[Any, DummyAllocator, CollectorRegistry, dict[str, str]]) -> None:
    client, _, _, secrets_map = api_client
...
def test_status_endpoint_requires_read_scope(api_client: tuple[Any, DummyAllocator, CollectorRegistry, dict[str, str]]) -> None:
    client, _, _, secrets_map = api_client
...
def test_oversized_body_under_auth_returns_422(
    redis_url_for_api: str, httpx_client_factory
) -> None:
    registry = CollectorRegistry()
    allocator = DummyAllocator()
    write_token = "ValidToken1234567890"
