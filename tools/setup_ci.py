...
def run_validator() -> None:
    ...
    jenkins_patterns = [
        ...
        re.compile(r"PYTHONWARNINGS=default python3 -m scripts.deps.ensure_lock --root . install --attempts 3"),
        re.compile(r"PYTHONWARNINGS=default python3 -m pip install --no-deps -e ."),
