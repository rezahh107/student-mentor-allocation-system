...
def upgrade() -> None:
    ...
    op.execute('INSERT INTO "منتورها" ("شناسه_منتور","نام","جنسیت","نوع","ظرفیت","بار_فعلی","فعال") VALUES (1,\'A\',0,\'عادی\',60,0,true) ON CONFLICT DO NOTHING;')
    op.execute('INSERT INTO "منتورها" ("شناسه_منتور","نام","جنسیت","نوع","ظرفیت","بار_فعلی","فعال") VALUES (2,\'B\',1,\'مدرسه\',60,0,true) ON CONFLICT DO NOTHING;')
