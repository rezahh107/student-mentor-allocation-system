...
from security.signing import KeyRingSigner, keyring_from_definitions, deterministic_secret
...
def perf(rows: int = typer.Option(2000, min=10, help="Row count for the exporter benchmark")) -> None:
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        for idx in range(10):
            ...
            tracemalloc.stop()
            duration_sign = (datetime.now(tz=timezone.utc) - start).total_seconds()
